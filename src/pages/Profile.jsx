...
// Анимация плавного появления (скопирована из Home.jsx)
...
function Profile({ user, onLogout, favorites, myReviews, onRemoveFavorite, booksList, onDeleteQuote, onDeleteReview }) {
            ...
            <div style={{ marginBottom: '32px' }}>
              ...
              {favorites?.length === 0 ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {favorites.map((book) => (
                    <div key={book.id} style={itemCardStyle}>
                      <div>
